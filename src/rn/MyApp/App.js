...
function Section({ children, title }) {
  const isDarkMode = react_native_1.useColorScheme() === 'dark';
  return (
      ...
      <react_native_1.ScrollView contentInsetAdjustmentBehavior="automatic" style={backgroundStyle}>
        ...
        >
          <Section title="Step One">
            编辑 <react_native_1.Text style={styles.highlight}>App.tsx</react_native_1.Text> to change this screen and
